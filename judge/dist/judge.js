...
export class DockerJudge {
    ...
    async executeCode(request) {
        ...
        for (const testCase of request.testCases) {
            const executionResult = await this.executeTestCase(request.sourceCode, testCase, config, request.timeLimitMs || config.timeLimitMs, request.memoryLimitMB || config.memoryLimitMB);
    ...
    async executeTestCase(sourceCode, testCase, config, timeLimitMs, memoryLimitMB) {
